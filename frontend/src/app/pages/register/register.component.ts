    ...
    <div class="auth-container">
      <div class="auth-card">
        ...
        <div class="auth-logo-section">
          ...
          <p class="auth-subtitle">Join us to start booking rooms</p>
        </div>
        ...
        <form [formGroup]="registerForm" (ngSubmit)="onSubmit()" class="auth-form">
          ...
          <button mat-raised-button color="primary" type="submit" class="auth-submit-btn" [disabled]="registerForm.invalid || isLoading">
  ...
  onSubmit() {
    if (this.registerForm.valid) {
      ...
      this.authService.register(this.registerForm.value).subscribe({
        ...
        error: (err) => {
          this.isLoading = false;
          this.notificationService.error(err.error?.error || 'Registration failed. Please try again.');
        }
      });
    }
  }
